...
if ($text === '/start') {
    ...
    ✨ **Play Mystery**: Tap the dog bone and watch your balance fetch amazing rewards!
    🐕 **Mine for PUPS**: Collect Mysterious Tokens with every action your furry friend takes.
    ...
    🐾 **Get Started Now** and take your token on the ultimate Mysterious adventure!
    ...
    $post_fields = [
        ...
        'reply_markup' => json_encode([
            'inline_keyboard' => [
                [
                    ['text' => 'Play MysteryToken Now', 'web_app' => ['url' => 'https://tgapp-beta.vercel.app/']],
